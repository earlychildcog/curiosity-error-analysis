 %--------------------------------------------------------------------------
%
%   This script shows the standard pupil size analysis pipeline, as
%   appliedt
...
% edfraw_folder   = './wandering/';
% expName         = 'wandering';
% edfraw_folder   = './us/';
% expName         = 'US';
expName         = 'PETRA';
edfraw_folder   = ['./' expName '/'];

batchFileConverter_Dataset3(edfraw_folder,expName);

% Get files:
folderName       = [ edfraw_folder './matlabData/'];
...
customSettings.valid.interp_maxGap   = 1000;
